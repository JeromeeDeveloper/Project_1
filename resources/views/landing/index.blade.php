                    ...
                    <ul class="nav">
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li><a href="{{ route('contest.details') }}">Single Contest</a></li>
                            </ul>
                        </li>
      ...
      <div class="row">
        ...
        <div class="col-lg-6">
          <div class="main-button">
            <a href="{{ route('categories') }}">Discover All Categories</a>
          </div>
        </div>
        <div class="col-lg-3 col-sm-6">
          <div class="popular-item">
            ...
            <div class="border-button">
              <a href="{{ route('contest.details') }}">Browse Nature Pic Contests</a>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-sm-6">
          <div class="popular-item">
            ...
            <div class="border-button">
              <a href="{{ route('contest.details') }}">Browse Random Pic Contests</a>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-sm-6">
          <div class="popular-item">
            ...
            <div class="border-button">
              <a href="{{ route('contest.details') }}">Browse Portrait Pic Contests</a>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-sm-6">
          <div class="popular-item">
            ...
            <div class="border-button">
              <a href="{{ route('contest.details') }}">Browse Space Pic Contests</a>
            </div>
          </div>
        </div>
      </div>
